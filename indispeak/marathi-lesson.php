...
// ✅ STEP 2: Calculate progress for this Marathi course
$total_lessons = 10; // ⚙️ adjust based on total Marathi lessons in DB
...
// ✅ STEP 4: Fetch Marathi flashcards for this lesson
$cards = [];
...
<head>
  <meta charset="UTF-8">
  <title>Marathi Lesson Flashcards</title>
  <style>
    body {
      background: #ffe7d6;
...
<?php else: ?>
  <h2>No flashcards found for this Marathi lesson.</h2>
  <a href="lessons.php?course=<?php echo urlencode($course_name); ?>"><button>🔙 Back</button></a>
<?php endif; ?>
