...
<style>
body{font-family:Arial;text-align:center;background:#fffbe6;}
.card{margin:80px auto;background:white;width:420px;padding:30px;border-radius:15px;box-shadow:0 4px 15px rgba(0,0,0,0.15);}
button{margin:10px;padding:10px 18px;background:#db9b00;color:white;border:none;border-radius:8px;cursor:pointer;}
.hidden{display:none;}
</style>
</head>
<body>
